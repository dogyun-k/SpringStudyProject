...
public class PostController {
    ...
    public String postView(@RequestParam Long id, Model model) {
    ...
    public String createPost(@RequestParam Long userId, @RequestParam String title, @RequestParam String content) {
    ...
    public String updatePost(@RequestParam Long postId, @RequestParam String title, @RequestParam String content,
